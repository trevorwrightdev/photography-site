      ...
      <div className={styles.container}>
        ...
        <div className={styles.grid}>
          <div className={styles.photo}>
            ...
            <Image src={glacier} fill style={{objectFit: 'contain'}}/>
          </div>
          <div className={styles.photo}>
            <div className={styles.background}/>
            <Image src={glacier2} fill style={{objectFit: 'contain'}}/>
          </div>
          <div className={styles.photo}>
            <div className={styles.background}/>
            <Image src={glacier3} fill style={{objectFit: 'contain'}}/>
          </div>
          <div className={styles.photo}>
            <div className={styles.background}/>
            <Image src={glacier4} fill style={{objectFit: 'contain'}}/>
          </div>
          <div className={styles.photo}>
            <div className={styles.background}/>
            <Image src={glacier5} fill style={{objectFit: 'contain'}}/>
          </div>
          <div className={styles.photo}>
            <div className={styles.background}/>
            <Image src={glacier6} fill style={{objectFit: 'contain'}}/>
          </div>
          <div className={styles.photo}>
            <div className={styles.background}/>
            <Image src={glacier7} fill style={{objectFit: 'contain'}}/>
          </div>
          <div className={styles.photo}>
            <div className={styles.background}/>
            <Image src={glacier8} fill style={{objectFit: 'contain'}}/>
          </div>
          <div className={styles.photo}>
            <div className={styles.background}/>
            <Image src={glacier9} fill style={{objectFit: 'contain'}}/>
          </div>
          <div className={styles.photo}>
            <div className={styles.background}/>
            <Image src={glacier10} fill style={{objectFit: 'contain'}}/>
          </div>
        </div>
