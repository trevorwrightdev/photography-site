        ...
        <div className={styles.row}>
          ...
          <div className={styles.column}>
            ...
            <div className={styles.imageRow}>
              <Image src={Amanda1} width={180}/>
              <Image src={Amanda2} width={180}/>
              <Image src={Amanda3} width={180}/>
              <Image src={Amanda4} width={180}/>
            </div>
            <p className={styles.description}>
              This was my art project in 2020. I painted my backyard walls for my kids. It’s special because I
never thought in a million years I could actually create something so cool for my kids (I promise
I’m not an artist that can draw). This painting represents my daughter Rose (it’s baby Moana). I
also painted the garden wall as Bikini Bottom for Charlie. It’s definitely an art project I’m proud
of, not only because I didn’t think I could do it but because of what it represents my family ♥️
            </p>
          </div>
        </div>
      </div>
